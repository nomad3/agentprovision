...
{{/*
Create configmap checksum annotation for pod restart on config changes
*/}}
{{- define "microservice.configmapChecksum" -}}
...
{{/*
Create secret checksum annotation for pod restart on secret changes
*/}}
